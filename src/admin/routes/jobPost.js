...
router.get(
  "/government-category",
  authenticate,
  categoryController.getGovernmentCategory
);

router.delete(
  "/delete-category/:categoryId",
  authenticate,
  categoryController.deleCategory
);
...
router.get(
  "/private-job-list",
  authenticate,
  jobPostController.getJobPostForApp
);

router.get(
  "/government-job-list",
  authenticate,
  jobPostController.getJobForGovernment
);
...
router.get("/filter-data", authenticate, jobPostController.getFilterData);
